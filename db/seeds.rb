...
m1 = Member.create(name: "Softie", age: 29, gym: g1)
m2 = Member.create(name: "Dopey", age: 25, gym: g1)
m3 = Member.create(name: "Big Lady", age: 40, gym: g1)
m4 = Member.create(name: "Moody", age: 31, gym: g1)
m5 = Member.create(name: "Morgan", age: 30, gym: g1)
m6 = Member.create(name: "Jr", age: 21, gym: g1)
m7 = Member.create(name: "Drake", age: 25, gym: g1)
m8 = Member.create(name: "Tag", age: 26, gym: g1)
m9 = Member.create(name: "Dunny", age: 18, gym: g1)
m10 = Member.create(name: "Patty", age: 20, gym: g1)
m11 = Member.create(name: "Lil Lady", age: 51, gym: g1)
