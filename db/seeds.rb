...
t1 = TrainingSession.create(member: m1, fitness_coach: f2, workout_type: w1, gym: g1)
t2 = TrainingSession.create(member: m1, fitness_coach: f2, workout_type: w2, gym: g1)
